...
namespace Persons
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Personen person1 = new Personen("Maria", 31, "Metzger");
            Personen person2 = new Personen("Reiner", 40, "Programmierer");
        ...
        public static void Menu(Personen person, string userName)
        {
            Console.Clear();
